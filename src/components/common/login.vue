...
<script>
    ...
    import { SET_MENU } from 'store/sidebar';
    ...
    export default {
        ...
        methods: {
            ...mapActions([USER_SIGNIN,SET_MENU]),
            getImg:function(){
                this.codeImg = apiAuth.API_URL+'/code?height=80&width=290&t='+new Date();
            },
            submit:function () {
                ...
                let _this = this;
                apiAuth.login(this, param).then(function (response) {
