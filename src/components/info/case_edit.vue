            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <router-link :to="{name: 'case_list'}">法律咨询</router-link>
                        </li>
                        <li>{{typeTitle}}</li>
                    </ul>
                    <!--breadcrumbs end -->
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body" id="form-data-case">
                            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" @submit.prevent="save">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">代号</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" placeholder="代号"  v-model.trim="param.code">
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            init: function () {
                this.uploadUrl = apiInfo.caseUploadUrl();
                this.type = this.$route.params.type;
                if (this.type == 2) {
                    this.typeTitle = '修改参数';
                    this.id = this.$route.params.id;
                    $("body").mLoading("show");
                    apiInfo.getRowCaseItem(this, this.id).then(function (response) {
