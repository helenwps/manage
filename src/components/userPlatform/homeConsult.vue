                                    ...
                                    <el-table :data="dataList" border style="width: 100%">
                                        ...
                                        <el-table-column label="操作" width="200">
                                            <template  slot-scope="item">
                                                <el-button size="mini" type="primary" @click="upDown('1',2,item.row.uuid)">上移</el-button>
                                                <el-button size="mini" type="primary" @click="upDown('-1',2,item.row.uuid)">下移</el-button>
