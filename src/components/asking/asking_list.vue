                                    ...
                                    <el-table :data="dataList" border tooltip-effect="dark" style="width:100%">
                                        ...
                                        <el-table-column align="center" label="操作" prop="operate" width="300">
                                            <template slot-scope="scope">
                                                <!-- //查看功能下期再做 -->
                                                <!-- <el-button type="info" @click="showInfo(scope.row.id)" size="mini">查看</el-button> -->
                                                <el-button type="success" v-if="scope.row.publicStatus==0" size="mini" @click="showHide(scope.row.id,scope.row.publicStatus)" >显示</el-button>
