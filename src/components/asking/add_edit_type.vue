            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li @click="back"> <a href="javascript:void(0)">问题分类</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel-body">
                                        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="width:600px;margin-left:50px">
    ...
    export default {
        ...
        data() {
          ...
          return {
            ...
            rules: {
              ...
              typeCode: [
                { required: true, message: '请选择自身级别', trigger: 'change',type:'number'}
              ],
              parentId: [
        ...
        methods: {
                  ...
                  if (valid)
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                          ...
                          let param={id,name,sortBy,parentId,typeCode}
            ...
            init: function () {
                ...
                asking.typeSelection(this).then(function (response) {
                    let body = response.body;
