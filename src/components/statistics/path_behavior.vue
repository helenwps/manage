<template>
    ...
    <div id="main-content">
        <div class="wrapper">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <router-link :to="{name: 'statistics_path_behavior'}">
                        <el-tag class="activeTag">行为事件</el-tag>
                    </router-link>
                </div>
            </div>
            ...
            <charts-units ref="pathAnalyseCharts" :apiAct="pathAnalyseApi.getBehaviorStatistics" :isInit="isInit" v-on:getAsync="getAsync">
                <div class="row" slot="header">
                    <div class="col-lg-4">行为事件管理</div>
                </div>
            </charts-units>
