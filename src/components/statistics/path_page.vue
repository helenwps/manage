<template>
    ...
    <div id="main-content">
        <div class="wrapper">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <router-link :to="{name: 'statistics_path_page'}">
                        <el-tag class="activeTag">页面事件</el-tag>
                    </router-link>
                            ...
                            <el-row>
                                <el-col :span="24">
                                    <div class="grid-content bg-purple">
                                       <el-form-item>
                                            <el-select v-model="param.behaviorId" placeholder="行为" >
                                                <el-option
            ...
            <charts-units ref="pathAnalyseCharts" :apiAct="pathAnalyseApi.getPageStatistics" :isInit="isInit" v-on:getAsync="getAsync">
                <div class="row" slot="header">
                    <div class="col-lg-4">页面事件管理</div>
                </div>
            </charts-units>
