<template>
    ...
    <div id="main-content">
        <div class="wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-4">热门律师</div>
                                <div class="col-md-4 col-md-offset-4" style="text-align: right">
                                    <router-link class="btn btn-info btn-sm" :to="{name: 'lawyerUnallocated_list',params:{type:'hot'}}">
                                ...
                                <div class="panel-body panel-body-rest">
                                    <table class="table table-rest table-striped table-bordered border-top dataTable table-hover">
                                        ...
                                        <tr v-for="item in dataList">
                                            <td>
                                                <div style="width: 42px;height: 42px;margin:auto 0;cursor: pointer;">
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                <button title="删除热门律师" class="btn btn-danger btn-xs" @click="confirm(item)"><i class="glyphicon glyphicon-trash"></i></button>
                                            </td>
                                        </tr>
            ...
            <!-- 删除确认 -->
            <confirm v-on:confirm="hotAction" :message="message" :title="title"></confirm>
            <!-- 律师详情 -->
    ...
    export default {
        ...
        methods: {
            ...
            getResource: function (page, limit) {
                ...
                apiThird.hotLawyerList(this, param).then(function (response) {
            ...
            hotAction: function () {
                ...
                $("body").mLoading("show");
                apiThird.hotLawyerDel(this, this.rowItemId).then(function (response) {
                    let body = response.body;
                    apiThird.tips(this, {message: body.msg});
                    if (body && body.code == 1) {
