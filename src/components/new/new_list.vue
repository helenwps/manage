                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-md-offset-4" style="text-align: right">
                                    <router-link :to="{name: 'new_edit',params: {type:1,id:1}}" class="btn btn-info  btn-sm">
    ...
    export default {
        ...
        methods: {
            ...
            getResource: function (page, limit) {
                ...
                apiNew.newList(this, param).then(function (response) {
            ...
            deleteItem: function (id) {
                ...
                $("body").mLoading("show");
                apiNew.newDel(this, this.rowItemId).then(function (response) {
                    let body = response.body;
            ...
            modify: function (id) {
                this.$router.push({name: 'new_edit', params: {type: 2, id: id}});
            }
        }
    }
