            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                           <a href="javascript:;" @click="back">首页模块</a>
                        </li>
                        <li>{{typeTitle}}</li>
                    </ul>
                    <!--breadcrumbs end -->
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body" id="form-data-case">
                            <form class="form-horizontal" role="form" @submit.prevent="save">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">模版名<span class="required">*</span></label>
                                    <div class="col-lg-10">
...
<script>
    ...
    export default {
        ...
        methods: {
            init: function () {
                this.uploadUrl = apiNew.indexModuleUploadUrl();
                this.type = this.$route.params.type;
                if (this.type == 2) {
                    /*this.typeTitle = '修改参数';
                    this.id = this.$route.params.id;
                    $("body").mLoading("show");
                    apiNew.getRowCaseItem(this, this.id).then(function (response) {
            ...
            save: function () {
                ...
                $("body").mLoading("show");
                let commitType = 'indexModuleAdd';
                if (this.type == 2) {
                    commitType = 'indexModulePut';
                }
                let _this = this;
