                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-md-offset-4" style="text-align: right">
                                    <router-link :to="{name: 'book_types_edit',params: {type:1,id:1}}" class="btn btn-info btn-sm">
    ...
    export default {
        ...
        methods: {
            ...
            getResource: function (page, limit) {
                ...
                apiBook.typePage(this, param).then(function (response) {
            ...
            deleteItem: function (id) {
                ...
                $("body").mLoading("show");
                apiBook.typeDel(this, this.rowItemId).then(function (response) {
                    let body = response.body;
